...
urlpatterns = [
    ...
    url(r'^competition$', views.render, {'template': 'competition.html'}, name="competition"),
    url(r'^authors$', views.render, {'template': 'authors.html'}, name="authors"),
    url(r'^catalog$', views.render, {'template': 'catalog-mooc.html'}, name="catalog-mooc"),
    url(r'^catalogs$', views.render, {'template': 'catalogs.html'}, name="catalogs"),
